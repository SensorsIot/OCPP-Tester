...
class OcppServerLogic:
    ...
    async def run_e1_real_world_transaction_test(self):
        return await self.test_steps.run_e1_real_world_transaction_test()

    async def run_e2_set_charging_profile_6a(self):
        return await self.test_steps.run_e2_set_charging_profile_6a()

    async def run_e3_set_charging_profile_10a(self):
        return await self.test_steps.run_e3_set_charging_profile_10a()

    async def run_e4_set_charging_profile_16a(self):
        return await self.test_steps.run_e4_set_charging_profile_16a()
