...
CHANGELOG = {
    "1.3.22": {
        "date": "2025-11-15",
        "changes": [
            "Removed B.3 informational modal for smoother test execution",
            "B.3 Remote Smart Charging now runs directly without user confirmation",
            "Test automatically continues when using EV simulator",
